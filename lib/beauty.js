...
function getOne (req, res, next) {
    ...
    if(userInput.indexOf('布萊恩') === 0) {
        ...
        emit(userName, res, botPayload);
    } else if ( userInput.toLowerCase().indexOf('洗版') === 0 || 
                userInput.toLowerCase().indexOf('clear') === 0) {
    ...
    } else if (userInput.toLowerCase().indexOf('clark') === 0) {
        botPayload = {
        ...
        } else if (userInput.toLowerCase.indexOf('howdoyouturnthison') === 0) {
